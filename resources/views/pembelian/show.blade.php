    ...
    <div class="col-md-9">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold">Detail Faktur pembelian</h5>
                <span class="badge bg-primary fs-6">{{ $pembelian->no_faktur }}</span>
            </div>
            <div class="card-body p-5">
                    ...
                    <div class="col-md-6 text-end">
                        <table class="table table-borderless table-sm mb-0">
                            <tr>
                                ...
                                <td class="fw-bold">{{ date('d F Y', strtotime($pembelian->tanggal)) }}</td>
                            </tr>
                            <tr>
                                <td class="text-muted">Kepada Yth:</td>
                                <td class="fw-bold">{{ $pembelian->pemasok->nama_pemasok }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="text-end text-success fw-bold fs-5">Rp {{ number_format($pembelian->total_harga, 0, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <div class="mt-4">
                    ...
                    <p class="border p-2 bg-light">{{ $pembelian->keterangan }}</p>
                </div>
                @endif
